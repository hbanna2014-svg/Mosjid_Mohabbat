...
function DuaModule() {
  ...
  const allDuas = [
    ...
    { category: 'daily', arabic: 'اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا، وَبِكَ নَحْيَا، وَبِكَ نَمُوتُ وَإِلَيْكَ النُّشُورُ', bengali: 'হে আল্লাহ! আপনার অনুগ্রহে আমরা সকালে উপনীত হয়েছি এবং আপনার অনুগ্রহে আমরা সন্ধ্যায় উপনীত হয়েছি। আপনার নামেই আমরা জীবিত হই এবং আপনার নামেই আমরা মৃত্যুবরণ করি। আর আপনার দিকেই সবকিছুর প্রত্যাগমন।', ref: 'তিরমিযী: ৩৩৯১', importance: 'সকাল বেলার দোয়া' },
    { category: 'daily', arabic: 'سُبْحَانَ اللَّهِ وَبِحَمْدِهِ، سُبْحَانَ اللَّهِ الْعَظِيمِ', bengali: 'আল্লাহর পবিত্রতা বর্ণনা করছি তাঁর প্রশংসার সাথে, মহান আল্লাহর পবিত্রতা ঘোষণা করছি।', ref: 'বুখারী: ৬৬৮২', importance: 'জিকির (মিজানের পাল্লায় ভারী)' },
    ...
    { category: 'salat', arabic: 'اللَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ، وَشُكْرِكَ، وَحُسْنِ عِبَادَتِكَ', bengali: 'হে আল্লাহ! আপনাকে স্মরণ করতে, আপনার কৃতজ্ঞতা প্রকাশ করতে এবং আপনার সুন্দর ইবাদত করতে আমাকে সাহায্য করুন।', ref: 'আবু দাউদ: ১৫২২', importance: 'নামাজের পর বিশেষ দোয়া' },
    ...
    { category: 'distress', arabic: 'حَسْبُنَا اللَّهُ وَنِعْمَ الْوَكِيلُ', bengali: 'আল্লাহই আমাদের জন্য যথেষ্ট এবং তিনি কতই না চমৎকার কর্মবিধায়ক।', ref: 'সুরা আল-ইমরান: ১৭৩', importance: 'অসহায়ত্বের সময় দোয়া' },
    ...
    { category: 'protection', arabic: 'بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّমَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ', bengali: 'আল্লাহর নামে, যাঁর নামের বরকতে আসমান ও জমিনের কোনো কিছুই কোনো ক্ষতি করতে পারে না। তিনি সর্বশ্রোতা ও সর্বজ্ঞ।', ref: 'আবু দাউদ: ৫০৮৮', importance: 'ক্ষতি থেকে সুরক্ষার দোয়া' },
    { category: 'protection', arabic: 'أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ', bengali: 'আমি আল্লাহর নিখুঁত কালিমাগুলোর মাধ্যমে তাঁর সৃষ্টির সব অনিষ্ট থেকে আশ্রয় চাই।', ref: 'মুসলিম: ২৭০৮', importance: 'থাকার জায়গায় প্রবেশের দোয়া' },
  ];
